...
├── web/cheerpx/                         # CheerpX 1.3.3 (vendored)
├── web/extensions/
...
| 3 | CheerpX 1.3.3 loader + boot     | ✅     | Vendored at build time (engine + tun helpers); CDN fallback at runtime. Bumped from 1.2.11 in issue #15 — 1.2.11 crashed `cx.run` with exit 71. Tracked to latest 1.3.3 in issue #37. |
